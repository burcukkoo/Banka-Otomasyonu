...
namespace BankaApp
{
    public partial class BankaMusterileriGoruntule : Form
    {
        ...
        private void ListViewAyarla(ListView listviewAdi)
        {
            ...
            listviewAdi.Columns.Add("MÜŞTERİ ADI", 150, HorizontalAlignment.Center);
            listviewAdi.Columns.Add("MÜŞTERİ SOYADI", 150, HorizontalAlignment.Center);
            listviewAdi.Columns.Add("MÜŞTERİ TC NO", 150, HorizontalAlignment.Center);
            listviewAdi.Columns.Add("MÜŞTERİ HESAP NO", 150, HorizontalAlignment.Center);
            listviewAdi.Columns.Add("MÜŞTERİ BAKİYE", 150, HorizontalAlignment.Center);
        }
